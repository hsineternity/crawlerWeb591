...
countyNumber = { 'keelung' : '2', 'taipei' : '1', 'newtaipei' : '3', 'taoyuan' : '6', 'hsinchus' : '4', 'hsinchu' : '5', 'miaoli' : '7', 'taichung' : '8', 'nantou' : '11', 'changhua' : '10', 'yunlin' : '14', 'chiayis' : '12', 'chiayi' : '13', 'tainan' : '15', 'kaohsiung' : '17', 'pingtung' : '19', 'yilan' : '21', 'hualien' : '23', 'taitung' : '22', 'penghu' : '24', 'kinmen' : '25', 'lienchiang' : '26'}

def crawler591( citys ):
  countyHouseUrls = {}

  for city in citys:
    countyHouseUrls[city] = getBriefContent(countyNumber[city])

  for city, urls in countyHouseUrls.items():
    print(city)
    for url in urls:
      getDetailContent(url)
      houseId = re.findall(r'\d+', url)[-1]
      houseDetail = getDetailContent(url)
      print(houseId, houseDetail)
      # es.index( index=city, doc_type='house' , id=houseId, body=houseDetail )
